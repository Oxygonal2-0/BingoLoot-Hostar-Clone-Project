...
<?php
    ...
    <section class="banner1">
      ...
      <?php
          ...
          $sql1 = "SELECT * FROM newcontent WHERE content_lang ='".$movie."' AND content_type = 'movie' ";
          ...
          if($result1 == TRUE)
          {
            ...
            <div class="block1">
              <?php
                ...
                {
              ?>
                  <div class="headingsp capilize"><?php echo $movie; ?> </div>
                  <div class="maintrayp">
                  <?php
    ...
    <section class="trays">
        ...
        <!--Start Bollywood Binge -->
        <div class="block1">
            <div class="headings">Bollywood Binge</div>
            <div class="maintray">
        ...
        <!--Start Popular in Romance -->
        <div class="block1">
            <div class="headings">Popular In Romance</div>
            <div class="maintray">
